...
const colorPrimary = 0xFFF9F0E7; // 0xFFEADBCC;
const secondaryColor = 0xFFC3944F;
const whiteColor = 0xFFFFFFFF;
const usersCollection = 'users';
// const vermilion = 0xFFFA4A0C;
...
const lightDark = Color(0xFF0B0F14);
const brown = Color(0xFFD17842);
